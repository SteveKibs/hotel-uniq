...
Object = "{139DD5D1-D6E2-11D0-89D4-00A0C90833E6}#1.0#0"; "daxctle.ocx"
...
Begin VB.Form frmMenu 
   ...
   Begin MSDataGridLib.DataGrid MENULIST 
      ...
      EndProperty
   End
   Begin DAExpressLib.SpriteControl SpriteControl1 
      Height          =   615
      Left            =   1560
      TabIndex        =   1
      Top             =   4560
...
With openrecordset("select * from KitchenMenu")
While .EOF = False And FOUND = False
.MoveFirst
If h = !FOODNO Then
...
Else
.AddNew
!FOODNO = Me.txtFoodNo.Text
!FoodName = Me.txtFoodName.Text
!FoodCost = Me.txtFoodCost.Text
!DateAdded = Me.txtDateAdded.Text
.Update
.Requery
...
Me.cmdDelete.Enabled = True
With openrecordset("select * from KitchenMenu")
Set MENULIST.DataSource = openrecordset("select * from KitchenMenu")
End With
End Sub
